"""
Concrete consumer implementations for processing queue messages.

This module provides concrete implementations of the EventConsumer protocol,
including AsyncLoopConsumer for simple, single-instance deployments.
"""
