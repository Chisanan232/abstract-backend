...
[![GitHub release](https://img.shields.io/github/v/release/Chisanan232/abstract-backend?display_name=tag&color=24292e&logo=github)](https://github.com/Chisanan232/abstract-backend/releases)
...
[![PyPI version](https://img.shields.io/pypi/v/abstract-backend?label=PyPI&color=306998&logo=pypi)](https://pypi.org/project/abstract-backend/)
...
[![TestPyPI version](https://img.shields.io/badge/dynamic/json?label=TestPyPI&color=ff6600&query=%24.info.version&url=https%3A%2F%2Ftest.pypi.org%2Fpypi%2Fabstract-backend%2Fjson&logo=pypi)](https://test.pypi.org/project/abstract-backend/)
...
flowchart LR
    ...
    jobs[Build → Publish preview docs]:::jobs
