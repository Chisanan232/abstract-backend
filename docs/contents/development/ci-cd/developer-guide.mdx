...
- **GHCR Staging**: `docker pull ghcr.io/Chisanan232/abstract-backend:1.0.0-rc.0`
...
docker pull chisanan232/abstract-backend:<VERSION>
docker run --rm chisanan232/abstract-backend:<VERSION> --version
```

#### GitHub Container Registry (GHCR)
```bash
# Verify Docker image availability and correct version tags
docker pull ghcr.io/chisanan232/abstract-backend:<VERSION>
docker run --rm ghcr.io/chisanan232/abstract-backend:<VERSION> --version
```
