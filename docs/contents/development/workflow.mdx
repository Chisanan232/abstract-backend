...
This guide outlines the recommended workflow for contributing to the Abstract Backend project.
...
- Browse existing [GitHub Issues](https://github.com/Chisanan232/abstract-backend/issues) to find something to work on
...
1. Go to the [Abstract Backend repository](https://github.com/Chisanan232/abstract-backend)
...
git remote add upstream https://github.com/Chisanan232/abstract-backend.git
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/abstract-backend/discussions)
