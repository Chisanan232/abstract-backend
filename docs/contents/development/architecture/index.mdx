...
This page explains how the Abstract Backend is organized and how the main building blocks (source code, automation, and documentation) work together. Use it as a map when adapting the template to your own project.
